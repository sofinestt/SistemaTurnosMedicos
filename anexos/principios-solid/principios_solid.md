...
LSP (Liskov Substitution Principle): las subclases deben poder sustituir a sus clases base sin alterar el comportamiento del sistema. 

+ [Sustitución de Liskov (LSP)](anexos\principios-solid\03-lsp.md)

ISP (Interface Segregation Principle): es mejor tener varias interfaces específicas que una sola interfaz general con métodos innecesarios. 

+ [Segregación de Interfaces (ISP)](anexos\principios-solid\04-isp.md)

DIP (Dependency Inversion Principle): los módulos de alto nivel no deben depender de módulos de bajo nivel, sino de abstracciones. 
