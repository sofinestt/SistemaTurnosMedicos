...
1. El sistema solicita los datos del paciente (nombre, DNI o identificador).
1. La secretaria ingresa o selecciona el paciente existente.
1. El sistema solicita fecha, hora y tipo de consulta (Control o Primera vez).
1. La secretaria ingresa los datos del turno.
1. El sistema verifica que el horario esté disponible y no exista superposición.
1. El sistema registra el turno y lo muestra en la agenda del profesional.
1. El sistema envía una notificación de confirmación al paciente.
...
1. El sistema muestra los datos del turno actual.
1. La secretaria selecciona la opción “Reprogramar”.
1. El sistema solicita la nueva fecha y hora.
1. La secretaria ingresa el nuevo horario deseado.
1. El sistema verifica disponibilidad en el nuevo horario.
1. El sistema actualiza el turno con la nueva fecha y hora.
1. El sistema registra el cambio en el historial (quién reprogramó, cuándo, desde qué horario hacia cuál).
1. El sistema envía notificación al paciente informando el nuevo horario.
...
1. El actor confirma la cancelación.
1. El sistema cambia el estado del turno a “Cancelado”.
1. El sistema registra la cancelación en el historial: quién canceló, fecha y hora de la cancelación.
1. El sistema envía notificación al paciente confirmando la cancelación.
1. Si corresponde, el sistema notifica al médico del cambio en su agenda.
...
1. El médico selecciona la opción “Autorizar sobreturno” para ese horario.
1. El sistema solicita confirmación explícita del médico.
1. El médico confirma la autorización.
1. El sistema registra el sobreturno como autorizado, indicando el médico que autorizó y el momento de la autorización.
1. La secretaria puede ahora crear el turno adicional en ese horario.
1. El sistema muestra el sobreturno diferenciado visualmente en la agenda.
...
1. El sistema muestra el turno con su horario previsto.
1. La secretaria selecciona la opción “Registrar llegada”.
1. El sistema registra la hora actual como hora real de llegada del paciente.
1. El sistema crea un registro de presencia asociado al turno.
1. El sistema actualiza el estado del turno a “Paciente presente”.
1. El médico puede ver en su agenda que el paciente ya está en sala de espera.
